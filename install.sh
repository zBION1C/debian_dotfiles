...
sudo cp /opt/niri/resources/niri.desktop /urs/local/share/wayland-sessions
sudo cp /opt/niri/resources/niri-portals.conf /urs/local/share/xdg-desktop-portal
