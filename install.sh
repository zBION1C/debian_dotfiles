...
sudo cp /opt/niri/resources/niri.desktop /usr/local/share/wayland-sessions
sudo cp /opt/niri/resources/niri-portals.conf /usr/local/share/xdg-desktop-portal
